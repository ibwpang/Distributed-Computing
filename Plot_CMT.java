...
public class Plot_CMT extends JFrame {

    private int index = 0;
    //private int[] val = new int[MAX_SAMPLES];
    private double[] dist = new double[51];
    ...
    public void paint(Graphics g) {
        ...
        //     vp = v;
        // }
        System.out.println("All done successfully, please check the results. You can stop this process and try another topology or try another topology in another command terminal.");
        //System.exit(0);
    }
